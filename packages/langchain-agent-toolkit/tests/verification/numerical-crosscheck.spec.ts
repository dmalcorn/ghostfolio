...
import { validateNumericalCrosscheck } from '../../src/verification/numerical-crosscheck';
...
describe('validateNumericalCrosscheck', () => {
  ...
  it('should accept custom allocation field name', () => {
    const toolCalls: ToolCallRecord[] = [
      {
        name: 'portfolio_analysis',
        input: {},
        output: {
          holdings: [
            { symbol: 'A', weight: '60.00' },
            { symbol: 'B', weight: '40.00' }
          ]
        }
      }
    ];
